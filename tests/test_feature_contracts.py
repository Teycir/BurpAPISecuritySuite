...
def test_llm_prompt_uses_ai_prep_and_truncation_context():
    text = _source_text()
    required_tokens = [
        ...
        "Require non-destructive PoCs",
        "triage-proof evidence",
        "no wiggle room in severe triage",
    ...
    print("[PASS] test_llm_prompt_uses_ai_prep_and_truncation_context")


def test_enhanced_ai_prompt_prioritizes_sensitive_data_and_novelty():
    text = _source_text()
    required_tokens = [
        "def _generate_enhanced_ai_prompt(",
        "Advanced API Exploit Discovery (High ROI, Low Duplicate)",
        "unauthorized sensitive-data access or unauthorized state changes",
        ...
        "non-destructive exploit narrative that leaves no wiggle room in severe triage",
        "Require non-destructive PoCs only",
        "sensitive_data_target",
        "duplicate_risk",
        "why_novel",
        "evidence_used",
    ...
    print("[PASS] test_enhanced_ai_prompt_prioritizes_sensitive_data_and_novelty")
...
def test_ai_export_actions_are_wired_across_outputs():
    ...
    required_tokens = [
        ...
        "Require non-destructive PoCs that prove exploitability",
        "no wiggle room during severe triage",
        "- duplicate_risk",
        "- why_novel",
        "- sensitive_data_target",
        "- evidence_used",
...
def test_request_ai_prompt_prioritizes_sensitive_data_and_duplicate_control():
    text = _source_text()
    required_tokens = [
        ...
        "Every confirmed claim must be backed by exact request/response deltas",
        "- duplicate_risk",
        "- why_novel",
        "- sensitive_data_target",
        "- evidence_used",
    ...
    print("[PASS] test_request_ai_prompt_prioritizes_sensitive_data_and_duplicate_control")
